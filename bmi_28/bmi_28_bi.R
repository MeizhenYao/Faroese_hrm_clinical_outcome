...
for(i in 1:1991){
  s_lm <- (lm(bmi_28_bi ~ data.bmi_28_bi.met_age7[,i] + sex + mage + age7 , data = data.bmi_28_bi.met_age7))
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28_bi ~ data.bmi_28_bi.met_age14[,i] + sex + mage + age14 , data = data.bmi_28_bi.met_age14))
...
# "Met532"  "Met770"  "Met816"  "Met1148" "Met1692"
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28_bi ~ data.bmi_28_bi.met_age22[,i] + sex + mage + age22 , data = data.bmi_28_bi.met_age22))
...
#  "Met69"  "Met117" "Met128" "Met204" "Met316" "Met324" "Met414" "Met425" "Met433" "Met438" "Met443" "Met464" "Met541" "Met673"
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28_bi ~ data.bmi_28_bi.met_age28[,i] + sex + mage + age28 , data = data.bmi_28_bi.met_age28))
...
exwas_C18_bmi_28_bi_age7 <- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/hrm_clinical_outcome/bmi/bmi_28_bi/exwas_C18_bmi_28_bi_age7.csv")
exwas_C18_bmi_28_bi_age7$Mode <- rep("C18",nrow(exwas_C18_bmi_28_bi_age7))
exwas_C18_bmi_28_bi_age7 <- exwas_C18_bmi_28_bi_age7[exwas_C18_bmi_28_bi_age7$p.value < 0.001508217,]
...
exwas_C18_bmi_28_bi_age14 <- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/hrm_clinical_outcome/bmi/bmi_28_bi/exwas_C18_bmi_28_bi_age14.csv")
exwas_C18_bmi_28_bi_age14$Mode <- rep("C18",nrow(exwas_C18_bmi_28_bi_age14))
exwas_C18_bmi_28_bi_age14 <- exwas_C18_bmi_28_bi_age14[exwas_C18_bmi_28_bi_age14$p.value < 0.001508217,]
...
exwas_C18_bmi_28_bi_age28 <- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/hrm_clinical_outcome/bmi/bmi_28_bi/exwas_C18_bmi_28_bi_age28.csv")
exwas_C18_bmi_28_bi_age28$Mode <- rep("C18",nrow(exwas_C18_bmi_28_bi_age28))
exwas_C18_bmi_28_bi_age28 <- exwas_C18_bmi_28_bi_age28[exwas_C18_bmi_28_bi_age28$p.value < 0.001508217,]
