...
data_HILIC <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/HILIC/data_hilic.csv", check.names = F)
data_C18 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/C18/data_c18.csv", check.names = F)

merged_omics_HILIC <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/merged_omics_hilic.csv", check.names = F)
merged_omics_C18 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/merged_omics_c18.csv", check.names = F)
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28 ~ data.bmi_28.met_age7[,i] + sex + mage + age7 , data = data.bmi_28.met_age7))
...
write.table(mumm_bmi_28.met_age7, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_HILIC_bmi_28_age7.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age7,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age7.csv",
          row.names = F)

exwas_HILIC_bmi_28_age7 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age7.csv")
...
mumm_bmi_28.met_age7 <- mumm_bmi_28.met_age7[order(mumm_bmi_28.met_age7$p.value),]
write.table(mumm_bmi_28.met_age7, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_C18_bmi_28_age7.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age7,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age7.csv",
          row.names = F)

exwas_C18_bmi_28_age7 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age7.csv")
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28 ~ data.bmi_28.met_age14[,i] + sex + mage + age14 , data = data.bmi_28.met_age14))
...
write.table(mumm_bmi_28.met_age14, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_HILIC_bmi_28_age14.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age14,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age14.csv",
          row.names = F)

exwas_HILIC_bmi_28_age14 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age14.csv")
...
mumm_bmi_28.met_age14 <- mumm_bmi_28.met_age14[order(mumm_bmi_28.met_age14$p.value),]
write.table(mumm_bmi_28.met_age14, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_C18_bmi_28_age14.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age14,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age14.csv",
          row.names = F)

exwas_C18_bmi_28_age14 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age14.csv")
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28 ~ data.bmi_28.met_age22[,i] + sex + mage + age22 , data = data.bmi_28.met_age22))
...
write.table(mumm_bmi_28.met_age22, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_HILIC_bmi_28_age22.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age22,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age22.csv",
          row.names = F)

exwas_HILIC_bmi_28_age22 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age22.csv")
...
mumm_bmi_28.met_age22 <- mumm_bmi_28.met_age22[order(mumm_bmi_28.met_age22$p.value),]
write.table(mumm_bmi_28.met_age22, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_C18_bmi_28_age22.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age22,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age22.csv",
          row.names = F)

exwas_C18_bmi_28_age22 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age22.csv")
...
#  "Met69"  "Met324" "Met366" "Met425" "Met438" "Met464"
...
for(i in 1:1991){
  s_lm <- (lm(bmi_28 ~ data.bmi_28.met_age28[,i] + sex + mage + age28 , data = data.bmi_28.met_age28))
...
write.table(mumm_bmi_28.met_age28, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_HILIC_bmi_28_age28.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age28,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age28.csv",
          row.names = F)

exwas_HILIC_bmi_28_age28 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_HILIC_bmi_28_age28.csv")
...
mumm_bmi_28.met_age28 <- mumm_bmi_28.met_age28[order(mumm_bmi_28.met_age28$p.value),]
write.table(mumm_bmi_28.met_age28, sep = "\t",
            "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/mummichog_C18_bmi_28_age28.txt",
            row.names = F, col.names = T)


write.csv(data.bmi_28.met_age28,
          "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age28.csv",
          row.names = F)

exwas_C18_bmi_28_age28 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age28.csv")
...
#   "Met69"  "Met71"  "Met117" "Met208" "Met285" "Met316" "Met324" "Met335" "Met340" "Met378" "Met406" "Met425" "Met430" "Met437" "Met438" "Met708"
...
exwas_C18_bmi_28_age7 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age7.csv")
exwas_C18_bmi_28_age7$Mode <- rep("C18",nrow(exwas_C18_bmi_28_age7))
exwas_C18_bmi_28_age7 <- exwas_C18_bmi_28_age7[exwas_C18_bmi_28_age7$p.value < 0.001508217,]
...
exwas_C18_bmi_28_age14 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age14.csv")
exwas_C18_bmi_28_age14$Mode <- rep("C18",nrow(exwas_C18_bmi_28_age14))
exwas_C18_bmi_28_age14 <- exwas_C18_bmi_28_age14[exwas_C18_bmi_28_age14$p.value < 0.001508217,]
...
exwas_C18_bmi_28_age28 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_C18_bmi_28_age28.csv")
exwas_C18_bmi_28_age28$Mode <- rep("C18",nrow(exwas_C18_bmi_28_age28))
exwas_C18_bmi_28_age28 <- exwas_C18_bmi_28_age28[exwas_C18_bmi_28_age28$p.value < 0.001508217,]
...
all_sig_hit <- all_sig_hits[, c("Met_id", "Beta" , "Std.Error", "z.value" , "p.value" ,"mz" ,
                                ...
                                "Adduct")]
write.csv(all_sig_hits, "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_allsig_metabolites_bmi_28.csv", row.names = F )
...
exwas_bmi_28 <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/exwas_allsig_metabolites_bmi_28.csv")
...
jpeg("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/BMI_28/plot_allsig_metabolites_bmi_28.jpeg",
...
C18_bmi_28_age7  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_C18_bmi_28_age7.csv")
C18_bmi_28_age7 <- C18_bmi_28_age7[C18_bmi_28_age7$Hits.sig >=3 ,]
C18_bmi_28_age7$age <- rep(7, nrow(C18_bmi_28_age7))

C18_bmi_28_age14  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_C18_bmi_28_age14.csv")
C18_bmi_28_age14 <- C18_bmi_28_age14[C18_bmi_28_age14$Hits.sig >=3 ,]
C18_bmi_28_age14$age <- rep(14, nrow(C18_bmi_28_age14))

C18_bmi_28_age22  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_C18_bmi_28_age22.csv")
...
HILIC_bmi_28_age7  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_HILIC_bmi_28_age7.csv")
HILIC_bmi_28_age7 <- HILIC_bmi_28_age7[HILIC_bmi_28_age7$Hits.sig >=3 ,]
HILIC_bmi_28_age7$age <- rep(7, nrow(HILIC_bmi_28_age7))

HILIC_bmi_28_age14  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_HILIC_bmi_28_age14.csv")
HILIC_bmi_28_age14 <- HILIC_bmi_28_age14[HILIC_bmi_28_age14$Hits.sig >=3 ,]
HILIC_bmi_28_age14$age <- rep(14, nrow(HILIC_bmi_28_age14))

HILIC_bmi_28_age22  <- read.csv("C:\\Users\\midyav01\\OneDrive - The Mount Sinai Hospital\\MSSM Projects\\METABOLOMICS\\New_faroese\\hrm_clinical_outcome\\BMI_28\\metaboanalyst\\mummichog_pathway_enrichment_HILIC_bmi_28_age22.csv")
...
all_pathways <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/hrm_clinical_outcome/all_pathways.csv")
...
gp <- (gp +  geom_hline(yintercept = c(cumsum(ret))+0.5)
       ...
       + coord_cartesian(xlim = c(1.2, 6), ylim = c(0.5, 9), clip = "off") )

jpeg("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese//hrm_clinical_outcome/BMI_28/pathways_bmi_28.jpeg",
     units="in", width=12, height=10, res=600)
...
jpeg("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese//hrm_clinical_outcome/BMI_28/plot_metabolites_pathways_bmi_28.jpeg",
     units="in", width=24, height=15, res=800)
